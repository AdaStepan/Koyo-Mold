...
<script type = "text/javascript">
$(document).ready(function(){
$("#deletetbluser #allcheck").click(function(){
	if ($("#deletetbluser #allcheck").is(':checked')){
		$("#deletetbluser input[type=checkbox]").each(function(){
