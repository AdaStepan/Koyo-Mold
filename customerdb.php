...
<script language = "javascript" type="text/javascript">
		function run(row) {
			var x = row.cells;
			document.getElementById('acustomerid').value = x[1].innerHTML;
		};
</script>
</head>
<?php
...
?>
<div class = "custdb">
<p class = "searchform" id = "addresstblform" style = "text-align: center; left: 230px; color:black;">
