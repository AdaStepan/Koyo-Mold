...
<h1>Registration of Admin Users</h1>
		<form method = 'POST' action = "processadmin.php" name = "registration"> 
		...
		<input type="text" name="birthday" id="birthday" placeholder = "MM/DD/YYYY" maxlength="10" style = "position: relative; right: 165px;" readonly="readonly"></input></br></br>
		<label for="position">*Who Added You:</label>
